...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              include("travel-data.inc.php");
              sort($countries);
              function showButton($countryName){
                  $button = '<a href="list.php?country=' . $countryName . '" ';
                  $button .= 'role="button" class="btn btn-default">' . $countryName . '</a>';
                  return $button;
              }
              foreach ($countries as $countryName) {
                  echo showButton($countryName);
              }
              ?>
		...
		<ul class="caption-style-2">
          ...
          function showImg($image){
              $img = '<li><a href="detail.php?id=' . $image['id'] . '" class = "img-responsive">' .
                  '<img src="images/square/' . $image['path'] . '" alt="View of Cologne">' .
                  '<div class="caption"><div class="blur"></div><div class="caption-text"><h1>' . $image['title'] .
                  '</h1></div></div></a></li>';
              return $img;
          }
